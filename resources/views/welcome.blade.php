      ...
      <div class="navbar-container">
        <div class="collapse navbar-collapse justify-content-end" id="navbar-mobile">
          <ul class="nav navbar-nav mt-2">
            ...
            <li class="mr-3"><a href="{{ route('about') }}" class="text-sm text-gray-700 dark:text-gray-500 underline"><h5 class="text-white"><b>ABOUT US</b></h5></a></li>
            <li class="mr-3"><a href="{{ route('contact') }}" class="text-sm text-gray-700 dark:text-gray-500 underline"><h5 class="text-white"><b>CONTACT US</b></h5></a></li>
          </ul>
        </div>
      </div>
    </div>
