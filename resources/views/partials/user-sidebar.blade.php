    ...
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        <li class=" nav-item"><a href="index.html"><i class="la la-home"></i><span class="menu-title" data-i18n="nav.dash.main">Dashboard</span><span class="badge badge badge-info badge-pill float-right mr-2">3</span></a>
          <ul class="menu-content">
            <li><a class="menu-item" href="{{route('user.paid_bookings')}}" data-i18n="nav.dash.ecommerce"> Piad Booking</a>
            </li>
            <li class="menu-item "><a class="menu-item" href="{{route('user.unpaid_bookings')}}" data-i18n="nav.dash.crypto">UnPiad Booking</a>
            </li>
