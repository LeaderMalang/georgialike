      ...
      <div class="content-body">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">ADD NEW Hotel Category</h4>
                  ...
                  <div class="card-content collapse show">
                    <div class="card-body">
                      <form action="{{route('admin.hotel.category.store')}}"  enctype="multipart/form-data" class="steps-validation wizard-notification" method="POST">
                        <!-- Step 1 -->
                        <h6 class="danger">
                            @if($errors->any())
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">ALL Hotel Categories</h4>
                  ...
                  <table class="table table-de mb-0">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a
                          href="{{route('admin.hotel.category.destroy',$category->id)}}"
